...
def plot_diagnostics(s_start, indlistchunk, binarychunk,
                     datchunk, filteredchunk, threshold):
      ...
      # embed() # Start IPython
            ...
            for indlist in indlistchunk:
                ...
                if (set(indtemparray[:, 0]).intersection(np.arange(sampmin, sampmax + 1)) != set()):
                    ...
                    debug_fd.write('\n')
                    # makes sure everything is written to the debug file as
                    # program proceeds
                    debug_fd.flush()
